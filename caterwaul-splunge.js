...
var start = +new Date;
 ...
 return context.fillRect(v.v[0] - v.dv[0] , v.v[1] - v.dv[1] , 2*v.dv[0] , 2*v.dv[1])}) .call(this)) , chart.with_context(context, (function (c) {return chart.render(renderer(color_fn, c) , limit)})))}} ;
