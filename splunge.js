...
for (var rr = new rs.constructor() , ri = 0, rl = rs.length;
 ...
 return(function () {var xs = this.children() ;
 return renderable( {force:function () { ;
 return this.forced_ !== void 0 ? this.forced_: this.forced_ = bounded( (function (xs) {var x, x0, xi, xl, xr;
for (var xr = new xs.constructor() , xi = 0, xl = xs.length;
 xi < xl;
 ++xi) x = xs[xi] , xr.push( (x.transform_with(t))) ;
 return xr}) .call(this,xs))} , bound:function () { ;
 return this.force() .bound()} , children:function () { ;
 return this.force() .children()}})}) .call(this)}})} , bounded =function (xs) { ;
