...
; return vdot(vminus( b.v, bound.v) , bound.dv)} , renderable =function (x) { 
; return $.merge( x, {interpolate:function (b, x) { 
; return bounded_interpolation(this, b, x)} , transform_with:function (t) { 
; return(function () {var b = this.bound() , cs = this.children() 
; return renderable( {bound:function () { 
; return this.bound_ !== void 0 ? this.bound_: this.bound_ = b.transform_with(t)} , children:function () { 
...
; return xr}) .call(this, cs)}})}) .call(this)}})} , bounded =function (xs) { 
...
; return children}})}) .call(this)} , scale_size =function (l, x) {var b = l.bound() 
