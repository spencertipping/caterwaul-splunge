...
return(stop() ,_interval=setInterval(interpolator(_transform,t, +new Date,duration||400,tween||cosine) ,40) ) } ,transform=function() {;
return _transform} ,interpolator=function(s,t,c,d,i) {;
return function() {var now= +new Date;
return(now>c+d&& (stop() ,now=c+d) ,f(_transform=interpolate(s,t,i( (now-c) /d) ) ) ) } } ;
return{_transform:_transform,stop:stop,_interval:_interval,animate:animate,transform:transform,interpolator:interpolator} } ) .call(this) } ,point_hits=function(p,h) {;
