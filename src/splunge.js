...
return(function() {var sx=0,sy=0,start=null,last_selected=null,doc=jQuery(document) ,self=jQuery(canvas) ,reset_drag=function(e) {;
return(sx=e.pageX,sy=e.pageY,start=self.val() ) } ,start_dragging=function(e) {;
...
var h=c.height() ;
var ar=w/h;
return viewport(data,options.zoom||translate( [0,0] ) ,composite(polar_to_cartesian,bounding_box(box( [0,0] , [1,tau] ) ) ) ,options.logical_bound||box( [ -ar/2, -1/2] , [ar/w,1/h] ) ) } ,default_interaction=function(canvas,v) {;
